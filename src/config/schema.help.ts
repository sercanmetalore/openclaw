...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.provider":
    'Search provider ("brave", "firecrawl", "gemini", "grok", "kimi", "perplexity", or "searxng"). Auto-detected from available credentials if omitted.',
  ...
  "tools.web.search.searxng.baseUrl":
    'SearXNG base URL override (default: "http://localhost:8888").',
